...
func RedisKeyWorkerObservation(namespace, workerID string) string {
	return RedisNamespacePrefix(namespace) + "work:" + workerID
}
...
// Custom Redis key definitions

func RedisKeyPrefix(key string) string {
	return RedisNamespacePrefix(key)
}

// RedisKey2JobRetry Example am:retry
// <namespace>:retry
func RedisKey2JobRetry(namespace string) string {
	return RedisKeyPrefix(namespace) + "retry"
}

// RedisKey2JobDead Example am:dead
// <namespace>:dead
func RedisKey2JobDead(namespace string) string {
	return RedisKeyPrefix(namespace) + "dead"
}

// RedisKey2JobScheduled Example am:scheduled
// <namespace>:scheduled
func RedisKey2JobScheduled(namespace string) string {
	return RedisKeyPrefix(namespace) + "scheduled"
}

// RedisKey2Pools Example am:ps
// <namespace>:ps
func RedisKey2Pools(namespace string) string {
	return RedisKeyPrefix(namespace) + config.NameSpacePools
}

// RedisKey2Heartbeat Example am:ps:8680f0c176a0d547
// <namespace>:ps:<poolID>
func RedisKey2Heartbeat(namespace, poolID string) string {
	return RedisKeyPrefix(namespace) + fmt.Sprintf("%s:%s", config.NameSpacePools, poolID)
}

// RedisKey2Group Example am:gs:c4b75f3832f4ec8b
// <namespace>:gs:<poolID>
//func RedisKey2Group(namespace, poolID string) string {
//	return RedisKeyPrefix(namespace) + fmt.Sprintf("%s:%s", config.NameSpaceGroups, poolID)
//}

// RedisKey2ValidJobs Example am:validJobs
// <namespace>:validJobs
func RedisKey2ValidJobs(namespace string) string {
	return RedisKeyPrefix(namespace) + "validJobs"
}

// JobTypePrefix Example am:jts:
// <namespace>:jts
//func JobTypePrefix(namespace string) string {
//	return RedisKeyPrefix(RedisKeyPrefix(namespace) + config.NameSpaceJobType)
//}

// RedisKey2JobType Example am:jts:SyncAudienceRecordHiveCRM
// <namespace>:jts:<jobType>
//func RedisKey2JobType(namespace, jobType string) string {
//	return JobTypePrefix(namespace) + jobType
//}

// RedisKey2JobPrefix Example am:jbs:
// <namespace>:jbs:
func RedisKey2JobPrefix(namespace string) string {
	return RedisKeyPrefix(namespace) + config.NameSpaceJob + ":"
}

// RedisKey2Job Example am:jbs:SyncAudienceRecordHiveCRM
// <namespace>:jbs:<jobName>
func RedisKey2Job(namespace, jobName string) string {
	return RedisKey2JobPrefix(namespace) + jobName
}

// RedisKey2JobInProgress Example am:jbs:SyncAudienceRecordHiveCRM:8680f0c176a0d547:inprogress
// <namespace>:jbs:<jobName>:<poolID>:inprogress
func RedisKey2JobInProgress(namespace, poolID, jobName string) string {
	return fmt.Sprintf("%s:%s:inprogress", RedisKey2Job(namespace, jobName), poolID)
}

// RedisKey2JobPaused Example am:jbs:SyncAudienceRecordHiveCRM:paused
// <namespace>:jbs:<jobName>:paused
func RedisKey2JobPaused(namespace, jobName string) string {
	return RedisKey2Job(namespace, jobName) + ":paused"
}

// RedisKey2JobLock Example am:jbs:SyncAudienceRecordHiveCRM:lock
// <namespace>:jbs:<jobName>:lock
func RedisKey2JobLock(namespace, jobName string) string {
	return RedisKey2Job(namespace, jobName) + ":lock"
}

// RedisKey2JobLockInfo Example am:jbs:SyncAudienceRecordHiveCRM:lockInfo
// <namespace>:jbs:<jobName>:lockInfo
func RedisKey2JobLockInfo(namespace, jobName string) string {
	return RedisKey2Job(namespace, jobName) + ":lockInfo"
}

// RedisKey2JobConcurrency Example am:jbs:SyncAudienceRecordHiveCRM:limit
// <namespace>:jbs:<jobName>:limit
func RedisKey2JobConcurrency(namespace, jobName string) string {
	return RedisKey2Job(namespace, jobName) + ":limit"
}
...
return nil`, config.FetchKeysPerJobType)
...
return nil`, config.RequeueKeysPerJob)
...
// KEYS[N+1] = the last job's lock info hash
// ARGV[1] = the dead work pool id
